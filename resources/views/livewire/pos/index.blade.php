<div class="flex flex-col lg:flex-row min-h-screen gap-4 p-4 bg-gray-50 dark:bg-gray-900">
    ...
    <main class="lg:w-4/5 w-full flex flex-col gap-4">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded shadow-md mt-4">
            ...
            <div class="font-bold mb-2 text-gray-800 dark:text-gray-100">Total: {{ number_format($this->cartTotal) }}</div>
            ...
            <button wire:click="checkout" class="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white py-2 rounded transition">
                Checkout
            </button>
        </div>
    </main>
